...
namespace Main {
  ...
  function getMenuFudge(): Electron.MenuItemConstructorOptions[] {
    const menu: Electron.MenuItemConstructorOptions[] = [
      ...
      {
        label: "Edit", submenu: [
          { label: "Undo", id: Fudge.MENU.UNDO, click: menuSelect, accelerator: process.platform == "darwin" ? "Command+Z" : "Ctrl+Z", enabled: false },
          { label: "Redo", id: Fudge.MENU.REDO, click: menuSelect, accelerator: process.platform == "darwin" ? "Command+Shift+Z" : "Ctrl+Shift+Z", enabled: false },
